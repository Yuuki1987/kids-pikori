          ...
          <div class="d-flex justify-content-center">
              <div class="d-flex">
                  ...
                  <table class="table table-bordered">
                      <thead>
                          <tr class="hiragana-title">
                              <th scope="col" colspan="12">
                                  <h2 class="fs-3 fw-bold">ひらがなプログラム</h2>
                                  <h3>ひらがな単語<span class="fs-1">２</span>文字</h3>
                                  <button class="btn btn-info " id="text"><img src="../img/words2/<?php echo $random ?>.png" width="100px"></button>
                                  <form name="faceForm">
                                  ...
                                  <a href="../controllers/hiragana-2_controller.php" class="btn btn-primary fs-3">次へ</a>
                                  </form>
                                </div>
