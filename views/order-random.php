        ...
        <div class="d-flex">
            <table class="table table-borderless">
                ...
                <div>
                    ...
                    <p class="fs-4"><img src="<?php echo $Lines[$random_human] ?>" width="150px">の<?php if($front_back == 1):?>前（まえ）から<?php else: ?>後（うしろ）から<?php endif ?><?php echo $random ?>番目（ばんめ）は誰（だれ）ですか？</p>
                    </div>
